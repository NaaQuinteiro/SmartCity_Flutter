...
//? indica que a variável pode ser nula
  double? Latitude; //Armazena o texto do sensor
  double? Longitude; //Armazena o texto do sensor
  String Responsavel = ''; //Armazena o texto do sensor
  String Observacao = ''; //Armazena o texto do sensor
  String unidadeDeMedida = ''; //Armazena o texto do sensor
  ...
  final TextEditingController _responsavelcontroller =
      TextEditingController(); // privado //final: e uma contsante que vai defibir dps
  final TextEditingController _unidadeDeMedidacontroller =
      TextEditingController(); // privado //final: e uma contsante que vai defibir dps
  ...
  void dispose() {
    ...
    _unidadeDeMedidacontroller.dispose();
      ...
      home: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          children: [
            ...
            SizedBox(height: 20),
            //Aqui vamos inserir a caixa de texto  responsavel sensor
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20.0), //Espaço
              child: TextField(
                controller:
            ...
            SizedBox(height: 20),
            //Aqui vamos inserir a o campo status operacional sensor
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20.0), //Espaço
              child: Row(
                children: [
            ...
            SizedBox(height: 20),
            //Aqui vamos inserir a caixa de texto  observação sensor
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20.0), //Espaço
              child: TextField(
                controller:
