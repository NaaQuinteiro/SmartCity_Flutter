                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              'Latitude: ${sensor.latitude != null ? sensor.latitude!.toString() : 'N/A'}'),
                          Text(
                              'Longitude: ${sensor.longitude != null ? sensor.longitude!.toString() : 'N/A'}'),
                          Text('Responsável: ${sensor.responsavel ?? 'N/A'}'),
                          Text(
                              'Status Operacional: ${sensor.status_operacional ?? 'N/A'}'),
